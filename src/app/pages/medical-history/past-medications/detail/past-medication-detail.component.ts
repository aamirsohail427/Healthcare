...
@Component({
  selector: 'app-past-medication-detail',
  templateUrl: './past-medication-detail.component.html',
  styleUrls: ['./past-medication-detail.component.scss']
})
export class PastMedicationDetailComponent extends DetailPopupViewBase implements OnInit {
  ...
  public currentMedicationDetail: any;
  public dtsCourses: any[];

  constructor(private service: PastMedicationService) {
    super();
  }
  ...
  public editMedication(entity) {
    ...
    super.toggleLoadingPanel(true);
    this.currentMedicationDetail = _.cloneDeep(entity);
    this.initMedicationDetail();
  ...
  private getUserDetails() {
    this.service.getById(this.currentMedicationDetail.id).subscribe((response) => {
  ...
  private saveCallback = () => {
    ...
    this.initPopupToolbarItems();
    this.cloneRawData();
    this.currentMedicationDetail = { id: this.currentMedicationDetail.id };
    super.toggleLoadingPanel(false);
  }
